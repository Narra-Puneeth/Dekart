...
const Page1 = () => {
  ...
  <div className="custom-input">
    ...
    <div className="custom-dropdown">
      ...
      {selectedOption && <div className="small-text">Selected option: {selectedOption}</div>}
    </div>
    ...
    <div className="custom-dropdown">
      ...
      {selectedOption1 && <div className="small-text">Selected option: {selectedOption1}</div>}
    </div>
